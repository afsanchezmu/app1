...
<div class="wr-ajaxDiv" id="page18_grid_0">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page18_cell_0">
...
<tr><td nowrap="nowrap"> <c:if test="${webratio:evaluateCondition('cexpr_var15', 'index', pageContext)}"><c:set var="_wr_message"><bean:message key="confirmRollback"/></c:set>
	...
	<script type="application/json" class="wr-linkInfos">
		<webratio:LinkInfos page="page18"/>
	</script>
		<script type="application/json" class="wr-linkInfosSelective">
			<webratio:LinkInfos page="page18" selectiveRefresh="true"/>
		</script>
	<script type="application/json" class="wr-linkData">
		<webratio:LinkData page="page18"/>
	</script>
