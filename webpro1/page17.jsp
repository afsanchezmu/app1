...
<script type="text/javascript">if (typeof wr !== "undefined") { wr.ui.html.resx.refreshLoaded(); }</script>
  ...
  <body>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<div class="wr-ajaxDiv" id="page17HiddenFields">
   ...
   Active Items
		...
		<div id="body" class="container">	
			...
			<div id="grid" class="has-left ">
		    	<div class="wr-ajaxDiv" id="page17_grid_0">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page17_cell_0">
...
<c:if test="${webratio:evaluateCondition('cexpr_var13', 'index', pageContext)}">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page17_cell_12">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<input title="Search" onclick="$('#page17FormBean')[0].target='_self'" class=" button"  id="button:ln92" name="button:ln92" type="submit" value="Search">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page17_cell_24">
		...
		<div class="plain ">
			<div class="plain PowerIndexUnit">
				<table>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page17_cell_36">
	<div class="wr-ajaxDiv" id="page17_grid_1"><c:if test="${webratio:evaluateCondition('cexpr9', null, pageContext)}">
<div class="frame">
	<div class="frame-title">Work Item Details</div>
	<div class="frame-content">
<div class="container_12">
				<div class="grid_6 alpha agrd_12">
					<div class="wr-ajaxDiv" id="page17_cell_37">
...
<% } %></td>
			...
			<c:if test="${webratio:isTargetAccessible('ln88', pageContext)}">
				...
				<div class="grid_6 omega agrd_12">
					<div class="wr-ajaxDiv" id="page17_cell_43">
	<div class="wr-ajaxDiv" id="pu26_0">
<c:if test="${not(empty pu26) and (pu26.dataSize gt 0)}">
 <div class="plain ">
	...
	<script type="application/json" class="wr-linkInfos">
		<webratio:LinkInfos page="page17"/>
	</script>
		<script type="application/json" class="wr-linkInfosSelective">
			<webratio:LinkInfos page="page17" selectiveRefresh="true"/>
		</script>
	<script type="application/json" class="wr-linkData">
		<webratio:LinkData page="page17"/>
	</script>
