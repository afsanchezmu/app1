...
<c:if test="${not(empty qu1) and (qu1.dataSize gt 0)}">
                    ...
                    <tr>
                        <td>
                            <table border="0" cellspacing="1" cellpadding="2">
                                ...
                                <c:forEach var="current" varStatus="status" items="${qu1.data}">
