...
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page10_cell_13"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
	...
	<div class="wr-ajaxDiv" id="page10_grid_1"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('page10_grid_1,page10_cell_0,page10_grid_0', pageContext)}">
			<ControlData control="page10_grid_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="wr-ajaxDiv" id="page10_cell_1"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('page10_cell_1,page10_grid_1,page10_cell_0,page10_grid_0', pageContext)}">
			<ControlData control="page10_cell_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="panel panel-default ">
	...
	<div class="panel-body">
		...
		<c:if test="${webratio:isLayoutRefreshed('enu4_0,page10_cell_1,page10_grid_1,page10_cell_0,page10_grid_0', pageContext)}">
...
<div class="EntryUnit ">
	...
	<div class="row"><div class="col-md-offset-2 col-md-10">
		...
		<c:if test="${webratio:isLayoutRefreshed('pwu5_0,page10_cell_1,page10_grid_1,page10_cell_0,page10_grid_0', pageContext)}">
...
<c:otherwise>
		...
		<c:if test="${webratio:isLayoutRefreshed('page10_cell_13,page10_grid_0', pageContext)}">
			<ControlData control="page10_cell_13" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="dau4_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('dau4_0,page10_cell_13,page10_grid_0', pageContext)}">
