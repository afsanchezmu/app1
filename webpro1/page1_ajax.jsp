...
<div class="container_12">
				<div class="grid_7 alpha agrd_14">
					<div class="wr-ajaxDiv" id="page1_cell_0"></div>
				</div>
				<div class="grid_5 omega agrd_10">
					<div class="wr-ajaxDiv" id="page1_cell_7"></div>
				</div>
					<div class="clear"></div>
	...
	<div class="wr-ajaxDiv" id="inu1_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('inu1_0,page1_cell_0,page1_grid_0', pageContext)}">
...
<div>
	...
	<hr/>
		...
		<c:if test="${webratio:isLayoutRefreshed('page1_cell_7,page1_grid_0', pageContext)}">
			<ControlData control="page1_cell_7" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="page1_grid_1"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('page1_grid_1,page1_cell_7,page1_grid_0', pageContext)}">
			<ControlData control="page1_grid_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="wr-ajaxDiv" id="page1_cell_8"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('page1_cell_8,page1_grid_1,page1_cell_7,page1_grid_0', pageContext)}">
			<ControlData control="page1_cell_8" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="panel panel-default ">
	...
	<div class="panel-body">
		...
		<c:if test="${webratio:isLayoutRefreshed('enu1_0,page1_cell_8,page1_grid_1,page1_cell_7,page1_grid_0', pageContext)}">
...
<div class="EntryUnit ">
	...
	<div class="row"><div class="col-md-offset-2 col-md-10">
		...
		<c:if test="${webratio:isLayoutRefreshed('page1_cell_13,page1_grid_0', pageContext)}">
	...
	<div class="wr-ajaxDiv" id="mssu2_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('mssu2_0,page1_cell_13,page1_grid_0', pageContext)}">
