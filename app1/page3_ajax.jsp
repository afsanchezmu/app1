...
<div class="wr-ajaxDiv" id="mpage1_cell_0"></div>
	...
	<div class="wr-ajaxDiv" id="mpage1_grid_1"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
...
<c:out value="${dau2.data.userName}"/> 
		...
		<c:if test="${webratio:isLayoutRefreshed('ln35_0,mpage1_cell_0,mpage1_grid_0,mpage1_customlocation_0', pageContext)}">
			<ControlData control="ln35_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped"><c:if test="${webratio:evaluateCondition('cexpr5', null, pageContext)}"><a title="Home" id="ln35" class=" " href="<webratio:Link link="ln35" position="index"/>" >
		...
		<c:if test="${webratio:isLayoutRefreshed('mpage1_grid_1,mpage1_cell_0,mpage1_grid_0,mpage1_customlocation_0', pageContext)}">
			<ControlData control="mpage1_grid_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="container_12">
				<div class="grid_2 suffix_10 alpha omega agrd_4">
					<div class="wr-ajaxDiv" id="mpage1_cell_1"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
		...
		<c:if test="${webratio:isLayoutRefreshed('mpage1_cell_1,mpage1_grid_1,mpage1_cell_0,mpage1_grid_0,mpage1_customlocation_0', pageContext)}">
			<ControlData control="mpage1_cell_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="ln33_1"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('ln33_1,mpage1_cell_1,mpage1_grid_1,mpage1_cell_0,mpage1_grid_0,mpage1_customlocation_0', pageContext)}">
			<ControlData control="ln33_1" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped"><c:set var="_wr_message"><bean:message key="SeeuLater"/></c:set>
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
			...
			<span class="glyphicon "></span> </a></webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
									${inlineScripts}
		...
		<c:if test="${webratio:isLayoutRefreshed('mpage1_customlocation_2', pageContext)}">
			<ControlData control="mpage1_customlocation_2" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped"><div class="wr-ajaxDiv" id="mpage1_grid_3"></div></webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
									${inlineScripts}
		...
		<c:if test="${webratio:isLayoutRefreshed('mpage1_grid_3,mpage1_customlocation_2', pageContext)}">
			<ControlData control="mpage1_grid_3" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="wr-ajaxDiv" id="mpage1_cell_14"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('mpage1_cell_14,mpage1_grid_3,mpage1_customlocation_2', pageContext)}">
			<ControlData control="mpage1_cell_14" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped"></webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
									${inlineScripts}
