...
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page19_cell_12"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
		...
		<c:if test="${webratio:isLayoutRefreshed('page19_cell_0,page19_grid_0', pageContext)}">
			<ControlData control="page19_cell_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu11_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('enu11_0,page19_cell_0,page19_grid_0', pageContext)}">
			<ControlData control="enu11_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="frame">
	...
	<div class="frame-content">
	 <div class="plain ">
		...
		<c:if test="${webratio:isLayoutRefreshed('page19_cell_12,page19_grid_0', pageContext)}">
			<ControlData control="page19_cell_12" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu12_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('enu12_0,page19_cell_12,page19_grid_0', pageContext)}">
