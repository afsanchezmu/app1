...
<PageRefresh>
		...
		<LinkData>
			<![CDATA[<webratio:LinkData page="page13"/>]]>
		</LinkData>
...
<c:out value="${dau8.data.userName}"/> 
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_customlocation_0', pageContext)}">
			<ControlData control="page13_customlocation_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped"><div class="wr-ajaxDiv" id="page13_grid_2"></div></webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
									${inlineScripts}
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_grid_2,page13_customlocation_0', pageContext)}">
			<ControlData control="page13_grid_2" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="wr-ajaxDiv" id="page13_cell_60"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_60,page13_grid_2,page13_customlocation_0', pageContext)}">
			<ControlData control="page13_cell_60" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="inu4_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('inu4_0,page13_cell_60,page13_grid_2,page13_customlocation_0', pageContext)}">
			<ControlData control="inu4_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<c:if test="${not(empty inu4) and (inu4.dataSize gt 0)}">
	...
	<div class="frame-content">
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_grid_0', pageContext)}">
			<ControlData control="page13_grid_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page13_cell_0"></div>
				</div>
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page13_cell_12"></div>
				</div>
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page13_cell_24"></div>
				</div>
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page13_cell_36"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_0,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="pwu8_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('pwu8_0,page13_cell_0,page13_grid_0', pageContext)}">
...
<c:if test="${webratio:evaluateCondition('cexpr_var13', 'index', pageContext)}">
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_12,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_12" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu6_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('enu6_0,page13_cell_12,page13_grid_0', pageContext)}">
...
<div class="EntryUnit ">
	...
	<div class="row"><div class="col-md-offset-2 col-md-10">
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_24,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_24" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="pwu7_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('pwu7_0,page13_cell_24,page13_grid_0', pageContext)}">
...
<div class="panel panel-default ">
	...
	<div class="panel-body">
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_36,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_36" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="page13_grid_1"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_grid_1,page13_cell_36,page13_grid_0', pageContext)}">
			<ControlData control="page13_grid_1" type="text/html">
...
<div class="container_12">
				<div class="grid_6 alpha agrd_12">
					<div class="wr-ajaxDiv" id="page13_cell_37"></div>
				</div>
				<div class="grid_6 omega agrd_12">
					<div class="wr-ajaxDiv" id="page13_cell_43"></div>
				</div>
					<div class="clear"></div>
</div>
</div>
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_37,page13_grid_1,page13_cell_36,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_37" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="dau6_0"></div>
		...
		<c:if test="${webratio:isLayoutRefreshed('dau6_0,page13_cell_37,page13_grid_1,page13_cell_36,page13_grid_0', pageContext)}">
...
<% } %></td>
		...
		<c:if test="${webratio:isLayoutRefreshed('page13_cell_43,page13_grid_1,page13_cell_36,page13_grid_0', pageContext)}">
			<ControlData control="page13_cell_43" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="pu20_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('pu20_0,page13_cell_43,page13_grid_1,page13_cell_36,page13_grid_0', pageContext)}">
			<ControlData control="pu20_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
