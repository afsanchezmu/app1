...
<html>
  <head>
    ...
    <title>Describe the defective computer</title>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<div class="wr-ajaxDiv" id="page19HiddenFields">
			...
			<html:hidden property="lastURL" styleId="lastURL_page19"/>
				<input type="hidden" name="ln141" value="<webratio:Link link="ln141"/>">
				<input type="hidden" name="ln142" value="<webratio:Link link="ln142"/>">
				<input type="hidden" name="ln143" value="<webratio:Link link="ln143"/>">
				<input type="hidden" name="ln144" value="<webratio:Link link="ln144"/>">
	    ...
	    <div id="top">
	    	<div class="user">
	    		<div class="container">
	    			<div class="wr-ajaxDiv" id="sv3mpage4_customlocation_2"><div class="wr-ajaxDiv" id="sv3mpage4_grid_6">
<div class="wr-ajaxDiv" id="sv3mpage4_cell_76">
	<div class="wr-ajaxDiv" id="sv3dau11_0">
   ...
   Active Items
	    ...
	    <div class="container">
			<div id="breadcrumb">
				...
				<span>Describe the defective computer</span>
			</div>
			<div id="page-links">
			</div>
		</div>
		<div id="body" class="container">	
			<div id="left-column">
				<div class="wr-ajaxDiv" id="sv3mpage4_customlocation_1"><div class="wr-ajaxDiv" id="sv3mpage4_grid_2">
<div class="wr-ajaxDiv" id="sv3mpage4_cell_49">
	<div class="wr-ajaxDiv" id="sv3mpage4_grid_3">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_50">
	<div class="wr-ajaxDiv" id="sv3mpage4_grid_4">
<div class="wr-ajaxDiv" id="sv3mpage4_cell_51"><div class="frame">
	<div class="frame-title">Notes</div>
	<div class="frame-content">
		<div class="wr-ajaxDiv" id="sv3pwu12_0">
...
<span ><c:out value="${_wr_cutText}"  escapeXml="false"/></span>
			...
			<c:if test="${webratio:isTargetAccessible('sv3ln138', pageContext)}">
									...
									<td class=" value<c:if test="${sv3pwu12.currentIndex eq index}">Current</c:if>">
										<c:choose>
							   				<c:when test="${sv3pwu12.currentIndex eq index}">
												 <c:if test="${webratio:isTargetAccessible('sv3ln138', pageContext)}">
		 			<a title="delete" id="sv3ln138" onclick="return ajaxRequest('<webratio:Link link="sv3ln138" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3ln138', sourcePage: 'page19'}))" class=" linkCurrent" href="<webratio:Link link="sv3ln138" position="index"/>">							
					delete</a>
	</c:if>
							   				</c:when>
							   				<c:otherwise>
							   					 <c:if test="${webratio:isTargetAccessible('sv3ln138', pageContext)}">
		 			<a title="delete" id="sv3ln138" onclick="return ajaxRequest('<webratio:Link link="sv3ln138" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3ln138', sourcePage: 'page19'}))" class=" link" href="<webratio:Link link="sv3ln138" position="index"/>">							
					delete</a>
	</c:if>
							   				</c:otherwise>
							   			</c:choose>
					...
					<c:if test="${sv3pwu12.scroller.of gt 5}">
		 			...
		 			<a title="<bean:message key="PowerIndex.First"/>" id="sv3pwu12First" onclick="return ajaxRequest('<webratio:Link link="sv3pwu12First" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu12First', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu12First" position="index"/>">							
					<bean:message key="PowerIndex.First"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Previous"/>" id="sv3pwu12Previous" onclick="return ajaxRequest('<webratio:Link link="sv3pwu12Previous" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu12Previous', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu12Previous" position="index"/>">							
					<bean:message key="PowerIndex.Previous"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Next"/>" id="sv3pwu12Next" onclick="return ajaxRequest('<webratio:Link link="sv3pwu12Next" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu12Next', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu12Next" position="index"/>">							
					<bean:message key="PowerIndex.Next"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Last"/>" id="sv3pwu12Last" onclick="return ajaxRequest('<webratio:Link link="sv3pwu12Last" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu12Last', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu12Last" position="index"/>">							
		...
		<div class="wr-ajaxDiv" id="sv3enu9_0">
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<c:if test="${webratio:isTargetAccessible('sv3ln132', pageContext)}">
 			...
 			<input title="Write" onclick="return ajaxRequest('page19FormBean', $H({isForm: true, pressedLink: 'button:sv3ln132', selectiveRefresh: true, sourcePage: 'page19'})) " class=" button"  id="button:sv3ln132" name="button:sv3ln132" type="submit" value="Write">
	</c:if>
 </td>
			</c:if>
					</tr>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_63">
	<div class="wr-ajaxDiv" id="sv3mpage4_grid_5">
<div class="wr-ajaxDiv" id="sv3mpage4_cell_64"><div class="frame">
	<div class="frame-title">Attachments</div>
	<div class="frame-content">
		<div class="wr-ajaxDiv" id="sv3pwu11_0">
<c:if test="${not(empty sv3pwu11) and (sv3pwu11.dataSize gt 0)}">
	...
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('sv3ln131', pageContext)}">
				<input title="delete" id="sv3ln131" class=" linkCurrent"  type="button" value="delete" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { return ajaxRequest('<webratio:Link link="sv3ln131" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3ln131', sourcePage: 'page19'})) } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; }  return c; ">
	</c:if>
							   				</c:when>
							   				<c:otherwise>
							   					 <c:set var="_wr_message"><bean:message key="confirmAttachmentDeletion"/></c:set>
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('sv3ln131', pageContext)}">
				<input title="delete" id="sv3ln131" class=" link"  type="button" value="delete" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { return ajaxRequest('<webratio:Link link="sv3ln131" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3ln131', sourcePage: 'page19'})) } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; }  return c; ">
	</c:if>
							   				</c:otherwise>
							   			</c:choose>
						   			</td>
					...
					<c:if test="${sv3pwu11.scroller.of gt 5}">
		 			...
		 			<a title="<bean:message key="PowerIndex.First"/>" id="sv3pwu11First" onclick="return ajaxRequest('<webratio:Link link="sv3pwu11First" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu11First', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu11First" position="index"/>">							
					<bean:message key="PowerIndex.First"/></a>
	</c:if>
								            </c:when>
								            <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Previous"/>" id="sv3pwu11Previous" onclick="return ajaxRequest('<webratio:Link link="sv3pwu11Previous" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu11Previous', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu11Previous" position="index"/>">							
					<bean:message key="PowerIndex.Previous"/></a>
	</c:if>
							                </c:when>
							                <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Next"/>" id="sv3pwu11Next" onclick="return ajaxRequest('<webratio:Link link="sv3pwu11Next" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu11Next', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu11Next" position="index"/>">							
					<bean:message key="PowerIndex.Next"/></a>
	</c:if>
					    		            </c:when>
						    	            <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Last"/>" id="sv3pwu11Last" onclick="return ajaxRequest('<webratio:Link link="sv3pwu11Last" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv3pwu11Last', sourcePage: 'page19'}))" class=" scroll" href="<webratio:Link link="sv3pwu11Last" position="index"/>">							
					<bean:message key="PowerIndex.Last"/></a>
	</c:if>
							                </c:when>
							                <c:otherwise>
		...
		<div class="wr-ajaxDiv" id="sv3enu10_0">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					<tr>
		...
		<c:if test="${not(empty page19FormBean.map.sv3fld16_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:sv3ln134  field" property="sv3fld16_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page19FormBean.map.sv3fld16_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
			...
			<c:if test="${webratio:isTargetAccessible('sv3ln134', pageContext)}">
 			...
 			<input title="Upload" onclick="return ajaxRequest('page19FormBean', $H({isForm: true, pressedLink: 'button:sv3ln134', selectiveRefresh: true, sourcePage: 'page19'})) " class=" button"  id="button:sv3ln134" name="button:sv3ln134" type="submit" value="Upload">
	</c:if>
 </td>
			</c:if>
					</tr>
			...
			<div id="grid" class="has-left ">
				<div class="wr-ajaxDiv" id="sv3mpage4_customlocation_0"><div class="wr-ajaxDiv" id="sv3mpage4_grid_0">
<div class="wr-ajaxDiv" id="sv3mpage4_cell_0"><div class="frame">
	<div class="frame-title">Process Details</div>
	<div class="frame-content">
		<div class="wr-ajaxDiv" id="sv3mpage4_grid_1">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_1">
	<div class="wr-ajaxDiv" id="sv3dau9_0">
			...
			<div class="plain DataUnit">
			    <table>
				  ...
				  <td colspan="6">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_13">
	<div class="wr-ajaxDiv" id="sv3dau10_0">
			...
			<div class="plain DataUnit">
			    <table>
				  ...
				  <td colspan="6">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_25">
	<div class="wr-ajaxDiv" id="sv3dau9_1">
<c:if test="${not(empty sv3dau9) and (sv3dau9.dataSize gt 0)}">
		<div class="plain ">
			<div class="plain DataUnit">
			    <table>
		...
		<c:if test="${webratio:isTargetAccessible('sv3ln120', pageContext)}">
			...
			<c:if test="${webratio:isTargetAccessible('sv3ln121', pageContext)}">
				...
				<td valign="middle">
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="sv3mpage4_cell_37">
	<div class="wr-ajaxDiv" id="sv3inu6_0">
...
<div class="container_12">
	...
	<div class="wr-ajaxDiv" id="enu11_0">
<div class="frame">
		...
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:text  size="25" styleId="fld18" styleClass="  field" property="fld18" readonly="false"/>
						</td>
								<td class="error"><span class=" error"><html:errors property="fld18"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld19" styleClass=" field" cols="35" rows="8" property="fld19" readonly="false"/>
						</td>
								<td class="error"><span class=" error"><html:errors property="fld19"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Defect description
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld20" styleClass=" field" cols="35" rows="8" property="fld20" readonly="false"/>
						</td>
								<td class="error"><span class=" error"><html:errors property="fld20"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Request date
				...
				<div style="padding-right: 24px; white-space: nowrap">
					<html:text  size="25" styleId="fld21_locale" styleClass="  field" property="fld21_locale" readonly="false" style="width: 100%; margin: 0"/>
					<c:choose><c:when test="false">
						...
						<script type="text/javascript">
							jQuery(function($) { 								
								...
								<td class="error"><span class=" error"><html:errors property="fld21_locale"/></span></td>
					 	</tr>
			<html:hidden property="fld17" styleId="fld17"/>
		  </table>
		</div>
	</div>
</div>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page19_cell_12">
	<div class="wr-ajaxDiv" id="enu12_0">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					<tr>
					...
					<table>
				      <tr>
			<c:if test="${webratio:isTargetAccessible('ln142', pageContext)}">
					  <td> <c:set var="_wr_message"><bean:message key="Confirm Finish"/></c:set>
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('ln142', pageContext)}">
			<input title="Finish" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { $('#page19FormBean')[0].target='_self' } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; } return c; " class=" button"  id="button:ln142" name="button:ln142" type="submit" value="Finish">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln143', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln143', pageContext)}">
			<input title="Save and Work Later" onclick="$('#page19FormBean')[0].target='_self'" class=" button"  id="button:ln143" name="button:ln143" type="submit" value="Save and Work Later">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln144', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln144', pageContext)}">
			<input title="Cancel" onclick="$('#page19FormBean')[0].target='_self'" class=" button"  id="button:ln144" name="button:ln144" type="submit" value="Cancel">
	</c:if>
 </td>
			</c:if>
					</tr>
