...
<html>
  <head>
    ...
    <title>Check, repair and configure the hardware or the software</title>
...
<script type="text/javascript">if (typeof wr !== "undefined") { wr.ui.html.resx.refreshLoaded(); }</script>
  ...
  <body>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<div class="wr-ajaxDiv" id="page23HiddenFields">
   ...
   Active Items
	    ...
	    <div class="container">
			<div id="breadcrumb">
				...
				<span>Check, repair and configure the hardware or the software</span>
			</div>
			<div id="page-links">
			</div>
		</div>
...
<c:if test="${not(empty sv4inu6) and (sv4inu6.dataSize gt 0)}">
		<div class="plain ">
			<div class="plain IndexUnit">
		    	...
		    	<div class="wr-ajaxDiv" id="page23_grid_0">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page23_cell_0">
	<div class="wr-ajaxDiv" id="enu20_0">
<div class="frame">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<html:hidden property="fld40" styleId="fld40"/>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page23_cell_12">
	<div class="wr-ajaxDiv" id="enu21_0">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					<tr>
	...
	<script type="application/json" class="wr-linkInfos">
		<webratio:LinkInfos page="page23"/>
	</script>
		<script type="application/json" class="wr-linkInfosSelective">
			<webratio:LinkInfos page="page23" selectiveRefresh="true"/>
		</script>
	<script type="application/json" class="wr-linkData">
		<webratio:LinkData page="page23"/>
	</script>
