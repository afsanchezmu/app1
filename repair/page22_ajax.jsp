...
<PageRefresh>
		...
		<LinkData>
			<![CDATA[<webratio:LinkData page="page22"/>]]>
		</LinkData>
...
<c:if test="${not(empty sv4inu6) and (sv4inu6.dataSize gt 0)}">
		...
		<c:if test="${webratio:isLayoutRefreshed('page22_grid_0', pageContext)}">
			<ControlData control="page22_grid_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page22_cell_0"></div>
				</div>
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page22_cell_12"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
		...
		<c:if test="${webratio:isLayoutRefreshed('page22_cell_0,page22_grid_0', pageContext)}">
			<ControlData control="page22_cell_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu18_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('enu18_0,page22_cell_0,page22_grid_0', pageContext)}">
			<ControlData control="enu18_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="frame">
	...
	<div class="frame-content">
	 <div class="plain ">
		...
		<c:if test="${webratio:isLayoutRefreshed('page22_cell_12,page22_grid_0', pageContext)}">
			<ControlData control="page22_cell_12" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu19_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('enu19_0,page22_cell_12,page22_grid_0', pageContext)}">
			<ControlData control="enu19_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
