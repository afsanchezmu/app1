...
<PageRefresh>
		...
		<HiddenFields page="page23">
			<![CDATA[
			<html:hidden property="CSRFToken"/>
			<html:hidden property="lastURL" styleId="lastURL_page23"/>
				<input type="hidden" name="ln163" value="<webratio:Link link="ln163"/>">
				<input type="hidden" name="ln164" value="<webratio:Link link="ln164"/>">
				<input type="hidden" name="ln165" value="<webratio:Link link="ln165"/>">
				<input type="hidden" name="ln166" value="<webratio:Link link="ln166"/>">
		...
		<LinkData>
			<![CDATA[<webratio:LinkData page="page23"/>]]>
		</LinkData>
...
<span ><c:out value="${_wr_cutText}"  escapeXml="false"/></span>
			...
			<c:if test="${webratio:isTargetAccessible('sv4ln138', pageContext)}">
									...
									<td class=" value<c:if test="${sv4pwu12.currentIndex eq index}">Current</c:if>">
										<c:choose>
							   				<c:when test="${sv4pwu12.currentIndex eq index}">
												 <c:if test="${webratio:isTargetAccessible('sv4ln138', pageContext)}">
		 			<a title="delete" id="sv4ln138" onclick="return ajaxRequest('<webratio:Link link="sv4ln138" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4ln138', sourcePage: 'page23'}))" class=" linkCurrent" href="<webratio:Link link="sv4ln138" position="index"/>">							
					delete</a>
	</c:if>
							   				</c:when>
							   				<c:otherwise>
							   					 <c:if test="${webratio:isTargetAccessible('sv4ln138', pageContext)}">
		 			<a title="delete" id="sv4ln138" onclick="return ajaxRequest('<webratio:Link link="sv4ln138" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4ln138', sourcePage: 'page23'}))" class=" link" href="<webratio:Link link="sv4ln138" position="index"/>">							
					delete</a>
	</c:if>
							   				</c:otherwise>
							   			</c:choose>
					...
					<c:if test="${sv4pwu12.scroller.of gt 5}">
		 			...
		 			<a title="<bean:message key="PowerIndex.First"/>" id="sv4pwu12First" onclick="return ajaxRequest('<webratio:Link link="sv4pwu12First" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu12First', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu12First" position="index"/>">							
					<bean:message key="PowerIndex.First"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Previous"/>" id="sv4pwu12Previous" onclick="return ajaxRequest('<webratio:Link link="sv4pwu12Previous" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu12Previous', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu12Previous" position="index"/>">							
					<bean:message key="PowerIndex.Previous"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Next"/>" id="sv4pwu12Next" onclick="return ajaxRequest('<webratio:Link link="sv4pwu12Next" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu12Next', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu12Next" position="index"/>">							
					<bean:message key="PowerIndex.Next"/></a>
		 			...
		 			<a title="<bean:message key="PowerIndex.Last"/>" id="sv4pwu12Last" onclick="return ajaxRequest('<webratio:Link link="sv4pwu12Last" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu12Last', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu12Last" position="index"/>">							
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<c:if test="${webratio:isTargetAccessible('sv4ln132', pageContext)}">
 			...
 			<input title="Write" onclick="return ajaxRequest('page23FormBean', $H({isForm: true, pressedLink: 'button:sv4ln132', selectiveRefresh: true, sourcePage: 'page23'})) " class=" button"  id="button:sv4ln132" name="button:sv4ln132" type="submit" value="Write">
	</c:if>
 </td>
			</c:if>
					</tr>
...
<c:if test="${not(empty sv4pwu11) and (sv4pwu11.dataSize gt 0)}">
	...
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('sv4ln131', pageContext)}">
				<input title="delete" id="sv4ln131" class=" linkCurrent"  type="button" value="delete" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { return ajaxRequest('<webratio:Link link="sv4ln131" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4ln131', sourcePage: 'page23'})) } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; }  return c; ">
	</c:if>
							   				</c:when>
							   				<c:otherwise>
							   					 <c:set var="_wr_message"><bean:message key="confirmAttachmentDeletion"/></c:set>
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('sv4ln131', pageContext)}">
				<input title="delete" id="sv4ln131" class=" link"  type="button" value="delete" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { return ajaxRequest('<webratio:Link link="sv4ln131" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4ln131', sourcePage: 'page23'})) } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; }  return c; ">
	</c:if>
							   				</c:otherwise>
							   			</c:choose>
						   			</td>
					...
					<c:if test="${sv4pwu11.scroller.of gt 5}">
		 			...
		 			<a title="<bean:message key="PowerIndex.First"/>" id="sv4pwu11First" onclick="return ajaxRequest('<webratio:Link link="sv4pwu11First" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu11First', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu11First" position="index"/>">							
					<bean:message key="PowerIndex.First"/></a>
	</c:if>
								            </c:when>
								            <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Previous"/>" id="sv4pwu11Previous" onclick="return ajaxRequest('<webratio:Link link="sv4pwu11Previous" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu11Previous', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu11Previous" position="index"/>">							
					<bean:message key="PowerIndex.Previous"/></a>
	</c:if>
							                </c:when>
							                <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Next"/>" id="sv4pwu11Next" onclick="return ajaxRequest('<webratio:Link link="sv4pwu11Next" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu11Next', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu11Next" position="index"/>">							
					<bean:message key="PowerIndex.Next"/></a>
	</c:if>
					    		            </c:when>
						    	            <c:otherwise>
		 			...
		 			<a title="<bean:message key="PowerIndex.Last"/>" id="sv4pwu11Last" onclick="return ajaxRequest('<webratio:Link link="sv4pwu11Last" position="index" selectiveRefresh="true"/>', $H({pressedLink: 'sv4pwu11Last', sourcePage: 'page23'}))" class=" scroll" href="<webratio:Link link="sv4pwu11Last" position="index"/>">							
					<bean:message key="PowerIndex.Last"/></a>
	</c:if>
							                </c:when>
							                <c:otherwise>
	 ...
	 <div class="plain ">
		...
		<c:if test="${not(empty page23FormBean.map.sv4fld16_preload)}">
		  <table>
		    <tr>
		      <td>
		        <html:checkbox styleClass="wr-submitButtons:sv4ln134  field" property="sv4fld16_clear" disabled="false"/> clear <a target="blank" href="<webratio:BLOB value="${page23FormBean.map.sv4fld16_preload}"/>">preview</a>
		      </td>
		    </tr>
		  </table>
		</c:if>
			...
			<c:if test="${webratio:isTargetAccessible('sv4ln134', pageContext)}">
 			...
 			<input title="Upload" onclick="return ajaxRequest('page23FormBean', $H({isForm: true, pressedLink: 'button:sv4ln134', selectiveRefresh: true, sourcePage: 'page23'})) " class=" button"  id="button:sv4ln134" name="button:sv4ln134" type="submit" value="Upload">
	</c:if>
 </td>
			</c:if>
					</tr>
...
<c:if test="${not(empty sv4inu6) and (sv4inu6.dataSize gt 0)}">
		...
		<c:if test="${webratio:isLayoutRefreshed('page23_grid_0', pageContext)}">
			<ControlData control="page23_grid_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page23_cell_0"></div>
				</div>
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page23_cell_12"></div>
				</div>
					<div class="clear"></div>
</div>
</webratio:CollectScripts>
		...
		<c:if test="${webratio:isLayoutRefreshed('page23_cell_0,page23_grid_0', pageContext)}">
			<ControlData control="page23_cell_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu20_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('enu20_0,page23_cell_0,page23_grid_0', pageContext)}">
			<ControlData control="enu20_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
<div class="frame">
	...
	<div class="frame-content">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<c:out value="${page23FormBean.map.fld41}" /><html:hidden property="fld41"/>
						</td>
								<td class="error"></td>
					 	</tr>
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<c:out value="${page23FormBean.map.fld42}" /><html:hidden property="fld42"/>
						</td>
								<td class="error"></td>
					 	</tr>
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld43" styleClass=" field" cols="35" rows="8" property="fld43" readonly="false"/>
						</td>
								<td class="error"><span class=" error"><html:errors property="fld43"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Request date
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<c:out value="${page23FormBean.map.fld44_locale}" /><html:hidden property="fld44_locale"/>
						</td>
								<td class="error"></td>
					 	</tr>
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<c:out value="${page23FormBean.map.fld45_locale}" /><html:hidden property="fld45_locale"/>
						</td>
								<td class="error"></td>
					 	</tr>
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<table>
			<c:forEach var="current" varStatus="status" items="${page23FormBean.map.msfld2List}">
				<tr>
					<td class=" multiselectionfield">
						<html:multibox styleClass="  multiselectionfield" property="msfld2" value="${current}" disabled="false" styleId="msfld2_${status.index}"/>
						   <c:out value="${page23FormBean.map.msfld2LabelList[status.index]}"/>
					</td>
				</tr>
			</c:forEach>
		</table>
						</td>
								<td class="error"><span class=" error"><html:errors property="msfld2"/></span></td>
					 	</tr>
			<html:hidden property="fld40" styleId="fld40"/>
		  </table>
		</div>
	</div>
</div>
		...
		<c:if test="${webratio:isLayoutRefreshed('page23_cell_12,page23_grid_0', pageContext)}">
			<ControlData control="page23_cell_12" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	<div class="wr-ajaxDiv" id="enu21_0"></div>
</webratio:CollectScripts>
					<c:if test="${wrBoxed and not(empty inlineScripts)}">
							<script type="text/javascript">
								wr.runScoped("${wrClientAppName}", function(ajaxRequest, WRAjaxRequest, $H, WRAjax, WRAjaxRequestUtils, WRAjaxRequestQueue, WREvent, WREventUtils, Form) {
		...
		<c:if test="${webratio:isLayoutRefreshed('enu21_0,page23_cell_12,page23_grid_0', pageContext)}">
			<ControlData control="enu21_0" type="text/html">
				<![CDATA[<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					...
					<table>
				      <tr>
			<c:if test="${webratio:isTargetAccessible('ln164', pageContext)}">
					  <td> <c:set var="_wr_message"><bean:message key="Confirm Finish"/></c:set>
	<% pageContext.setAttribute("_wr_message", org.apache.commons.lang.StringEscapeUtils.escapeJavaScript((String) pageContext.getAttribute("_wr_message")));%>
		<c:if test="${webratio:isTargetAccessible('ln164', pageContext)}">
			<input title="Finish" onclick=" var c = confirm('<c:out value="${_wr_message}"/>'); if (c) { $('#page23FormBean')[0].target='_self' } else { event.preventDefault ? event.preventDefault() : event.returnValue = false; } return c; " class=" button"  id="button:ln164" name="button:ln164" type="submit" value="Finish">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln165', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln165', pageContext)}">
			<input title="Save and Work Later" onclick="$('#page23FormBean')[0].target='_self'" class=" button"  id="button:ln165" name="button:ln165" type="submit" value="Save and Work Later">
	</c:if>
 </td>
			</c:if>
			<c:if test="${webratio:isTargetAccessible('ln166', pageContext)}">
					  <td> <c:if test="${webratio:isTargetAccessible('ln166', pageContext)}">
			<input title="Cancel" onclick="$('#page23FormBean')[0].target='_self'" class=" button"  id="button:ln166" name="button:ln166" type="submit" value="Cancel">
	</c:if>
 </td>
			</c:if>
					</tr>
