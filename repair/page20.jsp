...
<html>
  <head>
    ...
    <title>Decide if the cost is acceptable</title>
...
<script type="text/javascript">if (typeof wr !== "undefined") { wr.ui.html.resx.refreshLoaded(); }</script>
  ...
  <body>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<c:if test="${wrBoxed}">
			<script>
				jQuery("#page20FormBean").prop("action", "${wrBaseURI}form_page20.do${wrAjax ? '#!ajax=true' : ''}");
			</script>
		</c:if>
		<div class="wr-ajaxDiv" id="page20HiddenFields">
   ...
   Active Items
	    ...
	    <div class="container">
			<div id="breadcrumb">
				...
				<span>Decide if the cost is acceptable</span>
			</div>
			<div id="page-links">
			</div>
		</div>
...
<c:if test="${not(empty sv3inu6) and (sv3inu6.dataSize gt 0)}">
		<div class="plain ">
			<div class="plain IndexUnit">
		    	...
		    	<div class="wr-ajaxDiv" id="page20_grid_0">
<div class="container_12">
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page20_cell_0">
	<div class="wr-ajaxDiv" id="enu13_0">
<div class="frame">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			    ...
			    <html:options property="sfld20List" labelProperty="sfld20LabelList"/>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page20_cell_12">
	<div class="wr-ajaxDiv" id="enu14_0">
<div class="frame">
	 ...
	 <div class="plain ">
		<div class="plain EntryUnit">
			...
			<html:hidden property="fld22" styleId="fld22"/>
					...
					<div class="clear"></div>
				<div class="grid_12 alpha omega agrd_24">
					<div class="wr-ajaxDiv" id="page20_cell_24">
	<div class="wr-ajaxDiv" id="enu15_0">
	 <div class="plain ">
		<div class="plain EntryUnit">
				<table>
					<tr>
	...
	<script type="application/json" class="wr-linkInfos">
		<webratio:LinkInfos page="page20"/>
	</script>
		<script type="application/json" class="wr-linkInfosSelective">
			<webratio:LinkInfos page="page20" selectiveRefresh="true"/>
		</script>
	<script type="application/json" class="wr-linkData">
		<webratio:LinkData page="page20"/>
	</script>
